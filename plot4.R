...
with(HouseholdMini, {
  ...
  plot(HouseholdMini$DT, HouseholdMini$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
  ...
  plot(HouseholdMini$DT, HouseholdMini$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")  
